<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{ route('panel.admin.tampilan.home.add') }}" name="modal_popup" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input name="posisi" type="number" class="form-control" placeholder="Posisi" required/>
                    </div>
                </div>
                <div class="form-group">
                    <label>Page</label>
